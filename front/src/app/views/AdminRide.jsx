...
const AdminRide = () => {
  ...
  useEffect(() => {
    if (trajet['id_account']) {
      axios
        .get(
          URL_BACK + `/get/comments_by_user_id/${trajet['id_account'].id}`
        )
        .then((res) => {
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <img
              ...
              src={comment['rating_user_id'] && comment['rating_user_id'].img_profil ? comment['rating_user_id'].img_profil : '/src/app/assets/img/avatar.png'}
              alt=""
            />
          ...
          <div className="bg-Moonstone h-[90vh] p-8">
            <div className="flex items-center w-fit mx-auto">
              <img
                ...
                src={trajet['id_account'] && trajet['id_account'].img_profil ? trajet['id_account'].img_profil : '/src/app/assets/img/avatar.png'}
                alt=""
              />
